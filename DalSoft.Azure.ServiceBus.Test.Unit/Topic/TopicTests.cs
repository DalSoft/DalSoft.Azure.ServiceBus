...
using DalSoft.Azure.ServiceBus;
using DalSoft.Azure.ServiceBus.Topic;
using Microsoft.ServiceBus.Messaging;
using Moq;
using NUnit.Framework;

namespace DalSoft.Azure.ServiceBus.Test.Unit.Topic 
{
    [TestFixture]
    public class TopicTests
    {
        ...
        private Mock<ServiceBus.IServiceBusClientWrapper> _mockTopicClient;
        ...
        public void SetUp()
        {
            ...
            _mockTopicClient = new Mock<ServiceBus.IServiceBusClientWrapper>();
        }
        ...
        public void Ctor_TopicDoesNotExist_TopicIsCreated()
        {
            ...
            new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, TestSubscriptionId, true, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object);
        ...
        {
            var expectedQueueToBeDeleted = new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, TestSubscriptionId, true, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object).TopicName;

            _mockNamespaceManager.Setup(x => x.TopicExists(It.IsAny<string>())).Returns(false);

            new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, TestSubscriptionId, true, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object).DeleteTopic();
        ...
        {
            const string queueNameByConvention = "DalSoft.Azure.ServiceBus.Test.Unit.TestTopic";

            Assert.That(new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, TestSubscriptionId, true, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object).TopicName, Is.EqualTo(queueNameByConvention));
        }
        ...
        {
            Assert.That(new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, TestSubscriptionId, true, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object).SubscriptionId,
        ...
        public void Subscribe_SubscriptionIdIsNull_ThrowsArgumentNullException()
        {
            ...
            var exceptionResult = Assert.Throws<ArgumentNullException>(() => 
                new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, null, false, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object).
        ...
        public void Subscribe_SubscriptionIdIsGreaterThan50Characters_ThrowsArgumentException()
        {
            ...
            var exceptionResult = Assert.Throws<ArgumentException>(() => 
                new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, subscriptionIdGreaterThan50Characters, true, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object)
                .Subscribe(async x => { await Task.FromResult(0); }));
        ...
        public void Ctor_DeleteSubscriptionOnDisposeIsTrueAndSubscriptionIdIsNotNull_DeletesSubscriptionOnDispose()
        {
            ...
            using (var topic = new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, TestSubscriptionId, true, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object))
            {
            }
        ...
        public void Ctor_DeleteSubscriptionOnDisposeIsFalse_DoesNotDeleteSubscriptionOnDispose()
        {
            ...
            using (var topic = new Topic<TestTopic>(_mockNamespaceManager.Object, _mockTopicClient.Object, TestSubscriptionId, false, () => new Mock<ServiceBus.IServiceBusClientWrapper>().Object))
            {
            }
