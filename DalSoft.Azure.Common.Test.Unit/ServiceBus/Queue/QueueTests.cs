...
namespace DalSoft.Azure.Common.Test.Unit.ServiceBus.Queue
{
    ...
    public class QueueTests
    {
        ...
        public void Ctor_QueueDoesNotExist_QueueIsCreated()
        {
            ...
            new Queue<TestQueue>(_mockNamespaceManager.Object, _mockQueueClient.Object, ()=>new Mock<IServiceBusClientWrapper>().Object, MaxDeliveryCount);
        ...
        public void Ctor_SettingADifferentMaxDeliveryCountForAExistingQueue_ThrowsInvalidOperationException()
        {
            ...
            Assert.Throws<InvalidOperationException>(()=> new Queue<TestQueue>(_mockNamespaceManager.Object, _mockQueueClient.Object, ()=>new Mock<IServiceBusClientWrapper>().Object, MaxDeliveryCount), "The Azure SDK 2.3 only lets you set the MaxDeliveryCount when first creating the Queue. For existing queues you will need to change the MaxDeliveryCount manually via the Azure portal.");
        }
        ...
        {
            var expectedQueueToBeDeleted = new Queue<TestQueue>(_mockNamespaceManager.Object, _mockQueueClient.Object, ()=>new Mock<IServiceBusClientWrapper>().Object, MaxDeliveryCount).QueueName;

            _mockNamespaceManager.Setup(x => x.QueueExists(It.IsAny<string>())).Returns(false);

            new Queue<TestQueue>(_mockNamespaceManager.Object, _mockQueueClient.Object, ()=>new Mock<IServiceBusClientWrapper>().Object, MaxDeliveryCount).DeleteQueue();
        ...
        {
            const string queueNameByConvention = "DalSoft.Azure.Common.Test.Unit.ServiceBus.TestQueue";

            Assert.That(new Queue<TestQueue>(_mockNamespaceManager.Object, _mockQueueClient.Object, ()=>new Mock<IServiceBusClientWrapper>().Object, MaxDeliveryCount).QueueName, Is.EqualTo(queueNameByConvention));
        }
